...
// ===== AUTO REFRESH =====
let lastCount = document.querySelectorAll('.bubble-wrap').length;
...
function playNotifySound(){
    try{
        const audio = new Audio("/file/oxidvideos-ding-small-bell-sfx-233008.mp3");
        audio.volume = 0.5;
        audio.play();
    }catch(e){}
}
...
setInterval(()=>{
    ...
    .then(html=>{
        ...
        let newCount = doc.querySelectorAll('.bubble-wrap').length;
